...
console.log('task1d', multiply(5,6));
...
console.log('task3a',hungryDog(7,1));
console.log('task3b',hungryDog(2,0.583));
...
console.log('task6',annoyingSong(50));
